...
export const marketplaceCategories = [
  {
    ...
    slug: 'vehicles',
    image:
      'https://assets.jijistatic.com/art/attributes/categories/vehicles-x3.png',
    subCategories: [
      {
  ...
  },
  {
    ...
    slug: 'real-estate',
    image:
      'https://assets.jijistatic.com/art/attributes/categories/property-x3.png',
    subCategories: [
  ...
  },
  {
    ...
    image:
      'https://assets.jijistatic.com/art/attributes/categories/phones-x3.png',
    subCategories: [
  ...
  },
  {
    ...
    slug: 'electronics',
    image:
      'https://assets.jijistatic.com/art/attributes/categories/electronics-x3.png',
    subCategories: [
  ...
  },
  {
    ...
    slug: 'home-garden',
    image:
      'https://assets.jijistatic.com/art/attributes/categories/home-x3.png',
    subCategories: [
  ...
  },
  {
    ...
    image:
      'https://assets.jijistatic.com/art/attributes/categories/fashion-x3.png',
    subCategories: [
  ...
  },
  {
    ...
    image:
      'https://assets.jijistatic.com/art/attributes/categories/health-x3.png',
    subCategories: [
  ...
  },
  {
    ...
    slug: 'services',
    image:
      'https://assets.jijistatic.com/art/attributes/categories/services-new-x3.png',
    kind: 'service',
    serviceType: 'generic',
    subCategories: [
      ...
      {
        name: 'Clinics & Doctor Appointments',
  ...
  },
  {
    ...
    image:
      'https://assets.jijistatic.com/art/attributes/categories/repair-x3.png',
    subCategories: [
  ...
  },
  {
    ...
    image:
      'https://assets.jijistatic.com/art/attributes/categories/equipment-x3.png',
    subCategories: [
  ...
  },
  {
    ...
    image:
      'https://assets.jijistatic.com/art/attributes/categories/hobbies-x3.png',
    subCategories: [
      { name: 'Personal Mobility', slug: 'personal-mobility' },
  ...
  },
  {
    ...
    image:
      'https://assets.jijistatic.com/art/attributes/categories/babies-x3.png',
    subCategories: [
  ...
  },
  {
    ...
    image:
      'https://assets.jijistatic.com/art/attributes/categories/agriculture-x3.png',
    subCategories: [
  ...
  },
  {
    ...
    image:
      'https://assets.jijistatic.com/art/attributes/categories/animals-x3.png',
    subCategories: [
  ...
  },
  {
    ...
    slug: 'jobs',
    image:
      'https://assets.jijistatic.com/art/attributes/categories/jobs-x3.png',
    subCategories: [
      {
  ...
  },
  {
    ...
    image:
      'https://assets.jijistatic.com/art/attributes/categories/jobseekers-new-x3.png',
    subCategories: [
...
export const tailoredSelections = [
  {
    title: '36-72 V Electric Bicycle Conversion Kits',
    views: '7K+ Views',
    price: 'USh 417,793-628,758',
    images: [
      'https://images.unsplash.com/photo-1558981403-c5f9899a28bc?w=150&h=150&fit=crop',
      'https://images.unsplash.com/photo-1572044162444-ad60f128bdea?w=150&h=150&fit=crop',
      'https://images.unsplash.com/photo-1496180590890-50d7cb1b1d42?w=150&h=150&fit=crop',
    ],
  },
  {
    title: 'Universal Electric Mobility Parts',
    views: '7K+ Views',
    price: 'USh 72,390',
    images: [
      'https://images.unsplash.com/photo-1580274455092-23c2a13ee1bc?w=150&h=150&fit=crop',
      'https://images.unsplash.com/photo-1581092580497-e0d23cbdf1dc?w=150&h=150&fit=crop',
      'https://images.unsplash.com/photo-1533090161767-e6ffed986c88?w=150&h=150&fit=crop',
    ],
  },
  {
    title: 'E-Bike Motor Suspension and Hub Options',
    views: '15K+ Views',
    price: 'USh 206,829-268,877',
    images: [
      'https://images.unsplash.com/photo-1620050851862-793574d6b6df?w=150&h=150&fit=crop',
      'https://images.unsplash.com/photo-1558981852-426c6c22a060?w=150&h=150&fit=crop',
...
export const productGrid = [
  {
    id: 1,
    title: 'Freight Forwarder China to Uganda Door to Door Ddp Service',
    price: 'USh 12,410-20,683',
    moq: '1 kg',
    sold: '20 views',
    image:
      'https://images.unsplash.com/photo-1570710891163-6d815f470087?w=300&h=300&fit=crop',
    verified: true,
    years: 1,
  },
  {
    id: 2,
    title: 'Electric Infrared Cooker 2200-3500W Portable Induction Cooktop',
    price: 'USh 32,266-49,639',
    moq: '100 cartons',
    sold: '72 views',
    image:
  ...
  {
    id: 3,
    title: 'Factory Wholesale Fashion Color 48V 350W 500W Electric Moped',
    price: 'USh 306,106-330,926',
    moq: '1 piece',
    sold: '917 views',
    image:
      'https://images.unsplash.com/photo-1558981403-c5f9899a28bc?w=300&h=300&fit=crop',
    verified: true,
    years: 1,
  },
  {
    id: 4,
    title: '2000W Dual Core High Power Electric Stove Home Use',
    price: 'USh 28,956',
    moq: '2 pieces',
    sold: '9 sold',
    image:
      'https://images.unsplash.com/photo-1585659722983-3a6750f1883c?w=300&h=300&fit=crop',
    verified: true,
    years: 3,
  },
  {
    id: 5,
    title: 'EK Electric Bike Accessories 3 Speed Lead-Acid Battery 40 km',
    price: 'USh 248,194-330,926',
    moq: '1 piece',
    sold: '1386 views',
    image:
  ...
  {
    id: 6,
    title: 'EK Wholesale Best Seller 350W 48V 14" Brushless Electronic High',
    price: 'USh 455,023-672,192',
    moq: '100 pieces',
    sold: '100 sold',
    image:
      'https://images.unsplash.com/photo-1496180590890-50d7cb1b1d42?w=300&h=300&fit=crop',
    verified: true,
    years: 1,
  },
];
...
export const topDeals = [
  ...
  },
  {
    ...
    moq: '1',
    image:
      'https://images.unsplash.com/photo-1507580461466-932f38d6fc3a?w=300&h=300&fit=crop',
  },
  {
    id: 6,
    ...
    moq: '1',
    image:
      'https://images.unsplash.com/photo-1517420879524-86d64ac2f339?w=300&h=300&fit=crop',
  },
];
...
export const stores = [
  {
    ...
    contact: { email: 'sales@meled.com', phone: '+86 138 0013 8000' },
    verified: true,
    years: 11,
    staff: '70+',
    revenue: 'US$ 28.9M+',
  ...
  },
  {
    ...
    layoutStyle: 'bold',
    banner:
      'https://images.unsplash.com/photo-1504917595217-d4dc5ebe6122?w=1200&h=400&fit=crop',
    categories: ['Commercial Equipment & Tools'],
    location: {
      address: 'Industrial Zone, Shanghai, China',
      lat: 31.2304,
      lng: 121.4737,
    },
    contact: { email: 'sales@ironclad.cn', phone: '+86 020 9999 1234' },
    verified: true,
    years: 12,
    staff: '500+',
    revenue: 'US$ 800M+',
    ...
    products: [
      {
        title: 'Pro Welding Machine',
        price: 'USh 827,313',
        moq: '1 piece',
        image:
          'https://images.unsplash.com/photo-1504917595217-d4dc5ebe6122?w=300&h=300&fit=crop',
        categoryName: 'Commercial Equipment & Tools',
      },
    ],
    gallery: {
      image:
  ...
  },
  {
    ...
    themeColor: '#92400e',
    layoutStyle: 'furniture',
    banner:
      'https://images.unsplash.com/photo-1615529182904-14819c35d47a?w=1200&h=500&fit=crop',
    categories: ['Home, Furniture & Appliances'],
    location: {
      address: 'Xihu District, Hangzhou, China',
      lat: 30.2741,
      lng: 120.1551,
    },
    contact: { email: 'hello@luxefurnishings.com', phone: '+86 571 2222 3333' },
    verified: true,
    years: 14,
    staff: '120+',
    revenue: 'US$ 64.5M+',
    ...
    gallery: {
      image:
        'https://images.unsplash.com/photo-1615529182904-14819c35d47a?w=400&h=300&fit=crop',
      count: '1/24',
    },
  },
  {
    ...
    layoutStyle: 'apparel',
    banner:
      'https://images.unsplash.com/photo-1469334031218-e382a71b716b?w=1200&h=500&fit=crop',
    categories: ['Fashion'],
    location: {
      address: 'Haizhu District, Guangzhou, China',
      lat: 23.1291,
      lng: 113.2644,
    },
    contact: { email: 'wholesale@voguethreads.com', phone: '+86 20 8888 9999' },
    verified: true,
    years: 9,
    staff: '450+',
    revenue: 'US$ 320M+',
    ...
    products: [
      {
        ...
        moq: '20 pieces',
        image:
          'https://images.unsplash.com/photo-1515347619362-6734d71e7551?w=300&h=400&fit=crop',
