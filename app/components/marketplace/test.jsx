...
const ProductGridSchema = new mongoose.Schema(
  {
    ...
    shipping: {
      ...
      note: {
        type: String,
        default: 'Chat with supplier for delivery details.',
      },
    },
  },
  { timestamps: true },
...
export const TopDeal =
  mongoose.models.TopDeal || mongoose.model('TopDeal', TopDealSchema);
export const TailoredSelection =
  mongoose.models.TailoredSelection ||
  mongoose.model('TailoredSelection', TailoredSelectionSchema);
export const Product =
  mongoose.models.Product || mongoose.model('Product', ProductGridSchema);
export const ProductReview =
  mongoose.models.ProductReview ||
  mongoose.model('ProductReview', ReviewSchema); // <-- NEW MODEL
