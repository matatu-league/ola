    ...
    <div className="sticky top-6 space-y-4">
      ...
      <div className="bg-white border border-[#E3E3E4] rounded-sm">
        <h3 className="p-4 md:p-5 font-bold text-[15px] text-[#161823] border-b border-[#E3E3E4] bg-[#F8F8F8] tracking-tight flex items-center justify-between uppercase">
          ...
          <span className="text-[12px] font-medium text-[#8A8B91] bg-white border border-[#E3E3E4] px-2 py-0.5 rounded-sm">
            {cartItems.length} item{cartItems.length !== 1 ? 's' : ''}
          </span>
        </h3>

        {/* Items list */}
        <div className="p-4 md:p-5 max-h-[340px] overflow-y-auto custom-scrollbar border-b border-[#E3E3E4]">
            ...
            {cartItems.map(item => (
              <div key={item.id} className="flex gap-3">
                ...
                <div className="flex-1 min-w-0 flex flex-col justify-center">
                  <p className="text-[12px] font-semibold text-[#161823] line-clamp-2 leading-tight mb-1">
                    {item.product.title}
                  </p>
        ...
        <div className="p-4 md:p-5 space-y-2.5 bg-white rounded-b-sm">
          <div className="flex justify-between text-[12px] text-[#8A8B91] font-medium">
            <span>Subtotal</span>
          ...
          <div className="pt-3 border-t border-[#E3E3E4] flex justify-between items-center">
      ...
      <div className="bg-[#F8F8F8] border border-[#E3E3E4] rounded-sm p-4 md:p-5">
        <h4 className="text-[12px] font-bold text-[#161823] mb-3 uppercase tracking-wide">Need Help?</h4>
        <div className="space-y-2.5">
          <div className="flex items-center gap-2.5">
            <Phone size={13} className="text-[#161823] shrink-0" />
            <span className="text-[12px] font-medium text-[#161823]">{supportInfo.phoneNumber}</span>
          </div>
          <div className="flex items-center gap-2.5">
            <Mail size={13} className="text-[#161823] shrink-0" />
            <span className="text-[12px] font-medium text-[#161823]">{supportInfo.email}</span>
          </div>
        </div>
      </div>
