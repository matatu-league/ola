    ...
    <div className={`bg-white border rounded-sm transition-all duration-300
        ...
        <div className="p-5 md:p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="space-y-1.5 md:col-span-2">
            <label className="text-[12px] font-semibold text-[#161823]">
              Address (Street, Building) <span className="text-[#FE2C55]">*</span>
            </label>
            <div className="relative">
              <Search size={14} className="absolute left-3 top-1/2 -translate-y-1/2 text-[#8A8B91] z-10" />
              {isMapsLoaded ? (
                ...
                <input
                  ...
                  className="w-full bg-[#F8F8F8] border border-[#E3E3E4] rounded-sm pl-9 pr-3 py-2 text-[13px] text-[#161823] focus:border-[#161823] transition-colors outline-none"
                />
              )}
            </div>
          </div>
          ...
          {/* Instructions */}
          <div className="space-y-1.5 md:col-span-2">
            <label className="text-[12px] font-semibold text-[#161823]">Shipping Instructions <span className="text-[#8A8B91] font-normal">(Optional)</span></label>
            <textarea
          ...
          {shippingError && (
            <div className="md:col-span-2 flex items-center gap-2 text-[12px] text-[#FE2C55] font-semibold bg-[#FFF0F3] border border-[#FE2C55] p-3 rounded-sm">
      ...
      {isDone && (
        <div className="px-4 md:px-5 pb-4 pt-4 border-t border-[#E3E3E4] ml-9">
          <p className="text-[14px] font-semibold text-[#161823] mb-0.5">{shipping.fullName}</p>
          <p className="text-[12px] text-[#8A8B91]">{shipping.city} · {shipping.address} · {shipping.phoneNumber}</p>
        </div>
      )}
    </div>
  );
