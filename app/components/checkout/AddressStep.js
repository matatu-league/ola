        ...
        <div className="p-5 md:p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              {isMapsLoaded ? (
                <Autocomplete onLoad={ref => (autocompleteRef.current = ref)} onPlaceChanged={onPlaceChanged}>
                  <input
                    ...
                    className="w-full bg-[var(--s-surface,#F8F8F8)] border border-[var(--s-border,#E3E3E4)] rounded-[var(--s-radius,0.125rem)] pl-9 pr-3 py-2 text-[13px] text-[var(--s-text,#161823)] focus:border-[var(--s-text,#161823)] focus:bg-white transition-colors outline-none"
                  />
                </Autocomplete>
              ) : (
                <input
                  ...
                  className="w-full bg-[var(--s-surface,#F8F8F8)] border border-[var(--s-border,#E3E3E4)] rounded-[var(--s-radius,0.125rem)] pl-9 pr-3 py-2 text-[13px] text-[var(--s-text,#161823)] focus:border-[var(--s-text,#161823)] transition-colors outline-none"
                />
              )}
            </div>
          </div>
          ...
          <div className="space-y-1.5 md:col-span-2">
            ...
            <textarea
              ...
              className="w-full bg-[var(--s-surface,#F8F8F8)] border border-[var(--s-border,#E3E3E4)] rounded-[var(--s-radius,0.125rem)] px-3 py-2 text-[13px] outline-none focus:border-[var(--s-text,#161823)] transition-colors text-[var(--s-text,#161823)] placeholder:text-[var(--s-muted,#8A8B91)] resize-none h-20"
            />
          </div>

          {shippingError && (
            <div className="md:col-span-2 flex items-center gap-2 text-[12px] text-[var(--s-primary,#FE2C55)] font-semibold bg-[#FFF0F3] border border-[var(--s-primary,#FE2C55)] p-3 rounded-[var(--s-radius,0.125rem)]">
